...
const input = { brandName: 'Acme', websiteUrl: 'acme.com', businessModel: 'b2b', industryName: 'Energy & Utilities', context: '' };
...
test('validateTeaserInput requires brand, a real URL and a known business model', () => {
