...
function SavedAssessmentsPage({ assessments, onLoad, onDelete, onBack }) {
  return (
    <div className="max-w-4xl mx-auto p-8 animate-fade-in">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold text-[#1A1F2E]">Saved Assessments</h2>
          <p className="text-[#6B7280]">Up to 15 assessments stored locally</p>
        </div>
      ...
      {assessments.length === 0 ? (
        <div className="card p-12 text-center">
          ...
          <p className="text-[#6B7280]">Complete an assessment and click Save to store it here.</p>
        </div>
      ) : (
        <div className="space-y-3">
          {assessments.map((a, i) => {
            ...
            return (
              <div key={i} className="card p-5 flex items-center justify-between hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4">
                  {overallScore !== null && (
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => onDelete(i)} className="text-red-500 hover:text-red-700 hover:bg-red-50 p-2 rounded-lg transition-colors">
